...
// src/__version__.ts
init_cjs_shims();
var CONSTRAINTS = (_class = class _CONSTRAINTS {
  /**
   * The minimum and maximum supported versions of the Camoufox browser.
   */
  static __initStatic() {this.MIN_VERSION = "beta.19"}
  static __initStatic2() {this.MAX_VERSION = "1"}
  static asRange() {
...
var LOCAL_DATA = path.join(__dirname, "../data-files");
var PACKAGE_DATA = path.join(process.cwd(), "data-files");
var OS_ARCH_MATRIX = {
  "win": ["x86_64", "i686"],
  "mac": ["x86_64", "arm64"],
...
var Version = class _Version {
  ...
  static isSupportedPath(path5) {
    return _Version.fromPath(path5).isSupported();
  }
  static buildMinMax() {
...
var CamoufoxFetcher = class _CamoufoxFetcher extends GitHubDownloader {
  ...
  async extractZip(zipFile) {
    const zip = _admzip2.default.call(void 0, zipFile);
  ...
  async install() {
    ...
    try {
      ...
      this.setVersion();
      if (OS_NAME !== "win") {
        _child_process.execSync.call(void 0, `chmod -R 755 ${this.installDir}`);
      }
...
async function webdl(url, desc = "", bar = true, buffer = null) {
  ...
  const progressBar = bar ? new (0, _progress2.default)(`${desc} [:bar] :percent :etas`, {
    total: totalSize,
    width: 40
  }) : null;
  const chunks = [];
...
var _fingerprintgenerator = require('fingerprint-generator');
var BROWSERFORGE_DATA = loadYaml(_path.join.call(void 0, LOCAL_DATA.toString(), "browserforge.yml"));
var FP_GENERATOR = new (0, _fingerprintgenerator.FingerprintGenerator)({
  browsers: ["firefox"]
...
function isBuffer(value) {
  var _a, _b;
  return _nullishCoalesce(((_b = (_a = value == null ? void 0 : value.constructor) == null ? void 0 : _a.isBuffer) == null ? void 0 : _b.call(_a, value)), () => ( false));
}
...
function assertArray(value, assertion, message) {
  if (!isArray(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Array", value))));
  }
  if (assertion) {
...
function assertArrayBuffer(value, message) {
  if (!isArrayBuffer(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("ArrayBuffer", value))));
  }
}
function assertArrayLike(value, message) {
  if (!isArrayLike(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("array-like", value))));
  }
}
function assertAsyncFunction(value, message) {
  if (!isAsyncFunction(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("AsyncFunction", value))));
  }
}
function assertAsyncGenerator(value, message) {
  if (!isAsyncGenerator(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("AsyncGenerator", value))));
  }
}
function assertAsyncGeneratorFunction(value, message) {
  if (!isAsyncGeneratorFunction(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("AsyncGeneratorFunction", value))));
  }
}
function assertAsyncIterable(value, message) {
  if (!isAsyncIterable(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("AsyncIterable", value))));
  }
}
function assertBigint(value, message) {
  if (!isBigint(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("bigint", value))));
  }
}
function assertBigInt64Array(value, message) {
  if (!isBigInt64Array(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("BigInt64Array", value))));
  }
}
function assertBigUint64Array(value, message) {
  if (!isBigUint64Array(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("BigUint64Array", value))));
  }
}
function assertBlob(value, message) {
  if (!isBlob(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Blob", value))));
  }
}
function assertBoolean(value, message) {
  if (!isBoolean(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("boolean", value))));
  }
}
function assertBoundFunction(value, message) {
  if (!isBoundFunction(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Function", value))));
  }
}
function assertBuffer(value, message) {
  if (!isBuffer(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Buffer", value))));
  }
}
function assertClass(value, message) {
  if (!isClass(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Class", value))));
  }
}
function assertDataView(value, message) {
  if (!isDataView(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("DataView", value))));
  }
}
function assertDate(value, message) {
  if (!isDate(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Date", value))));
  }
}
function assertDirectInstanceOf(instance, class_, message) {
  if (!isDirectInstanceOf(instance, class_)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("T", instance))));
  }
}
function assertEmptyArray(value, message) {
  if (!isEmptyArray(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("empty array", value))));
  }
}
function assertEmptyMap(value, message) {
  if (!isEmptyMap(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("empty map", value))));
  }
}
function assertEmptyObject(value, message) {
  if (!isEmptyObject(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("empty object", value))));
  }
}
function assertEmptySet(value, message) {
  if (!isEmptySet(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("empty set", value))));
  }
}
function assertEmptyString(value, message) {
  if (!isEmptyString(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("empty string", value))));
  }
}
function assertEmptyStringOrWhitespace(value, message) {
  if (!isEmptyStringOrWhitespace(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("empty string or whitespace", value))));
  }
}
function assertEnumCase(value, targetEnum, message) {
  if (!isEnumCase(value, targetEnum)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("EnumCase", value))));
  }
}
function assertError(value, message) {
  if (!isError(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Error", value))));
  }
}
function assertEvenInteger(value, message) {
  if (!isEvenInteger(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("even integer", value))));
  }
}
function assertFalsy(value, message) {
  if (!isFalsy(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("falsy", value))));
  }
}
function assertFloat32Array(value, message) {
  if (!isFloat32Array(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Float32Array", value))));
  }
}
function assertFloat64Array(value, message) {
  if (!isFloat64Array(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Float64Array", value))));
  }
}
function assertFormData(value, message) {
  if (!isFormData(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("FormData", value))));
  }
}
...
function assertGenerator(value, message) {
  if (!isGenerator(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Generator", value))));
  }
}
function assertGeneratorFunction(value, message) {
  if (!isGeneratorFunction(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("GeneratorFunction", value))));
  }
}
function assertHtmlElement(value, message) {
  if (!isHtmlElement(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("HTMLElement", value))));
  }
}
function assertInfinite(value, message) {
  if (!isInfinite(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("infinite number", value))));
  }
}
function assertInRange(value, range, message) {
  if (!isInRange(value, range)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("in range", value))));
  }
}
function assertInt16Array(value, message) {
  if (!isInt16Array(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Int16Array", value))));
  }
}
function assertInt32Array(value, message) {
  if (!isInt32Array(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Int32Array", value))));
  }
}
function assertInt8Array(value, message) {
  if (!isInt8Array(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Int8Array", value))));
  }
}
function assertInteger(value, message) {
  if (!isInteger(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("integer", value))));
  }
}
function assertIterable(value, message) {
  if (!isIterable(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Iterable", value))));
  }
}
function assertMap(value, message) {
  if (!isMap(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Map", value))));
  }
}
function assertNan(value, message) {
  if (!isNan(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("NaN", value))));
  }
}
function assertNativePromise(value, message) {
  if (!isNativePromise(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("native Promise", value))));
  }
}
function assertNegativeNumber(value, message) {
  if (!isNegativeNumber(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("negative number", value))));
  }
}
function assertNodeStream(value, message) {
  if (!isNodeStream(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Node.js Stream", value))));
  }
}
function assertNonEmptyArray(value, message) {
  if (!isNonEmptyArray(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("non-empty array", value))));
  }
}
function assertNonEmptyMap(value, message) {
  if (!isNonEmptyMap(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("non-empty map", value))));
  }
}
function assertNonEmptyObject(value, message) {
  if (!isNonEmptyObject(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("non-empty object", value))));
  }
}
function assertNonEmptySet(value, message) {
  if (!isNonEmptySet(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("non-empty set", value))));
  }
}
function assertNonEmptyString(value, message) {
  if (!isNonEmptyString(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("non-empty string", value))));
  }
}
function assertNonEmptyStringAndNotWhitespace(value, message) {
  if (!isNonEmptyStringAndNotWhitespace(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("non-empty string and not whitespace", value))));
  }
}
function assertNull(value, message) {
  if (!isNull(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("null", value))));
  }
}
function assertNullOrUndefined(value, message) {
  if (!isNullOrUndefined(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("null or undefined", value))));
  }
}
function assertNumber(value, message) {
  if (!isNumber(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("number", value))));
  }
}
function assertNumericString(value, message) {
  if (!isNumericString(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("string with a number", value))));
  }
}
function assertObject(value, message) {
  if (!isObject(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Object", value))));
  }
}
function assertObservable(value, message) {
  if (!isObservable(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Observable", value))));
  }
}
function assertOddInteger(value, message) {
  if (!isOddInteger(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("odd integer", value))));
  }
}
function assertPlainObject(value, message) {
  if (!isPlainObject(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("plain object", value))));
  }
}
function assertPositiveNumber(value, message) {
  if (!isPositiveNumber(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("positive number", value))));
  }
}
function assertPrimitive(value, message) {
  if (!isPrimitive(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("primitive", value))));
  }
}
function assertPromise(value, message) {
  if (!isPromise(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Promise", value))));
  }
}
function assertPropertyKey(value, message) {
  if (!isPropertyKey(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("PropertyKey", value))));
  }
}
function assertRegExp(value, message) {
  if (!isRegExp(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("RegExp", value))));
  }
}
...
function assertSet(value, message) {
  if (!isSet(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Set", value))));
  }
}
function assertSharedArrayBuffer(value, message) {
  if (!isSharedArrayBuffer(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("SharedArrayBuffer", value))));
  }
}
function assertString(value, message) {
  if (!isString(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("string", value))));
  }
}
function assertSymbol(value, message) {
  if (!isSymbol(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("symbol", value))));
  }
}
function assertTruthy(value, message) {
  if (!isTruthy(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("truthy", value))));
  }
}
function assertTupleLike(value, guards, message) {
  if (!isTupleLike(value, guards)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("tuple-like", value))));
  }
}
function assertTypedArray(value, message) {
  if (!isTypedArray(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("TypedArray", value))));
  }
}
function assertUint16Array(value, message) {
  if (!isUint16Array(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Uint16Array", value))));
  }
}
function assertUint32Array(value, message) {
  if (!isUint32Array(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Uint32Array", value))));
  }
}
function assertUint8Array(value, message) {
  if (!isUint8Array(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Uint8Array", value))));
  }
}
function assertUint8ClampedArray(value, message) {
  if (!isUint8ClampedArray(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("Uint8ClampedArray", value))));
  }
}
function assertUndefined(value, message) {
  if (!isUndefined(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("undefined", value))));
  }
}
function assertUrlInstance(value, message) {
  if (!isUrlInstance(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("URL", value))));
  }
}
function assertUrlSearchParams(value, message) {
  if (!isUrlSearchParams(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("URLSearchParams", value))));
  }
}
function assertUrlString(value, message) {
  if (!isUrlString(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("string with a URL", value))));
  }
}
function assertValidDate(value, message) {
  if (!isValidDate(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("valid Date", value))));
  }
}
function assertValidLength(value, message) {
  if (!isValidLength(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("valid length", value))));
  }
}
function assertWeakMap(value, message) {
  if (!isWeakMap(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("WeakMap", value))));
  }
}
function assertWeakRef(value, message) {
  if (!isWeakRef(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("WeakRef", value))));
  }
}
function assertWeakSet(value, message) {
  if (!isWeakSet(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("WeakSet", value))));
  }
}
function assertWhitespaceString(value, message) {
  if (!isWhitespaceString(value)) {
    throw new TypeError(_nullishCoalesce(message, () => ( typeErrorMessage("whitespace string", value))));
  }
}
...
var RequestError = class extends Error {
  ...
  constructor(message, error, self) {
    ...
    this.code = _nullishCoalesce(error.code, () => ( "ERR_GOT_REQUEST_ERROR"));
...
var timer = (request) => {
  ...
  const handleError = (origin) => {
    origin.once(_events.errorMonitor, () => {
  ...
  const onUpload = () => {
    ...
    timings.phases.request = timings.upload - (_nullishCoalesce(timings.secureConnect, () => ( timings.connect)));
  };
...
var normalizeDataURL = (urlString, { stripHash }) => {
  ...
  const mimeType = _nullishCoalesce(((_a = mediaType.shift()) == null ? void 0 : _a.toLowerCase()), () => ( ""));
...
var MaxBufferError = (_class2 = class extends Error {
  ...
  constructor() {
    super("maxBuffer exceeded");_class2.prototype.__init2.call(this);;
  }
}, _class2);
...
// node_modules/.pnpm/responselike@3.0.0/node_modules/responselike/index.js
var Response = class extends _stream.Readable {
  ...
  constructor(cacheRequest, cacheAdapter) {
    ...
    this.request = () => (options, callback) => {
      ...
      if (typeof options === "string") {
        url = normalizeUrlObject(_url3.default.parse(options));
        options = {};
      } else if (options instanceof _url3.default.URL) {
        url = normalizeUrlObject(_url3.default.parse(options.toString()));
        options = {};
      } else {
        const [pathname, ...searchParts] = (_nullishCoalesce(options.path, () => ( ""))).split("?");
      ...
      const ee = new (0, _events2.default)();
      const normalizedUrlString = normalizeUrl(_url3.default.format(url), {
        stripWWW: false,
      ...
      if (options.body && options.method !== void 0 && ["POST", "PATCH", "PUT"].includes(options.method)) {
        if (options.body instanceof _stream2.default.Readable) {
          options.cache = false;
        } else {
          key += `:${_crypto2.default.createHash("md5").update(options.body).digest("hex")}`;
        }
      }
      ...
      const makeRequest = (options_) => {
        ...
        const handler = async (response) => {
          ...
          ee.emit("response", _nullishCoalesce(clonedResponse, () => ( response)));
          if (typeof callback === "function") {
            callback(_nullishCoalesce(clonedResponse, () => ( response)));
          }
        };
        try {
...
var cloneResponse = (response) => {
  const clone = new (0, _stream.PassThrough)({ autoDestroy: false });
...
async function getBodySize(body, headers) {
  ...
  if (distribution_default.string(body)) {
    return _buffer.Buffer.byteLength(body);
  }
  if (distribution_default.buffer(body)) {
    return body.length;
  }
  if (isFormData3(body)) {
    return _util.promisify.call(void 0, body.getLength.bind(body))();
  }
  return void 0;
}
  ...
  if (hasLookup || hasConnect || hasSecureConnect || hasSend) {
    once(request, "socket", (socket) => {
      ...
      if (socket.connecting) {
        const hasPath = Boolean(_nullishCoalesce(socketPath, () => ( _net2.default.isIP(_nullishCoalesce(_nullishCoalesce(hostname, () => ( host)), () => ( ""))) !== 0)));
...
var { Resolver: AsyncResolver } = _dns.promises;
...
var supportsALL = typeof _dns.ALL === "number";
...
var getIfaceInfo = () => {
  let has4 = false;
  let has6 = false;
  for (const device of Object.values(os.default.networkInterfaces())) {
...
var CacheableLookup = class {
  constructor({
    ...
    this._dnsLookup = lookup && _util.promisify.call(void 0, lookup);
    this.stats = {
      cache: 0,
      query: 0
    };
    if (this._resolver instanceof AsyncResolver) {
      ...
      this._resolve4 = _util.promisify.call(void 0, this._resolver.resolve4.bind(this._resolver));
      this._resolve6 = _util.promisify.call(void 0, this._resolver.resolve6.bind(this._resolver));
    }
  ...
  async lookupAsync(hostname, options = {}) {
    ...
    if (options.family === 6) {
      ...
      if (options.hints & _dns.V4MAPPED) {
        if (supportsALL && options.hints & _dns.ALL || filtered.length === 0) {
          map4to6(cached);
        } else {
          cached = filtered;
        }
    ...
    if (options.hints & _dns.ADDRCONFIG) {
      const { _iface } = this;
...
// node_modules/.pnpm/got@14.4.7/node_modules/got/dist/source/core/options.js
var [major, minor] = _process2.default.versions.node.split(".").map(Number);
...
var Options = class _Options {
  ...
  constructor(input, options, defaults2) {
    ...
    this._internals = cloneInternals(_nullishCoalesce(_nullishCoalesce((defaults2 == null ? void 0 : defaults2._internals), () => ( defaults2)), () => ( defaultInternals)));
    this._init = [..._nullishCoalesce((defaults2 == null ? void 0 : defaults2._init), () => ( []))];
    this._merging = false;
  ...
  set url(value) {
    ...
    if (url.hostname === "unix") {
      ...
      if (matches == null ? void 0 : matches.groups) {
        const { socketPath, path: path5 } = matches.groups;
        this._unixOptions = {
          socketPath,
          path: path5,
          host: ""
  ...
  set cookieJar(value) {
    ...
    if (setCookie.length === 4 && getCookieString.length === 0) {
      setCookie = _util.promisify.call(void 0, setCookie.bind(value));
      getCookieString = _util.promisify.call(void 0, getCookieString.bind(value));
  ...
  */
  ...
  [Symbol.for("nodejs.util.inspect.custom")](_depth, options) {
    return _util.inspect.call(void 0, this._internals, options);
  }
  createNativeRequestOptions() {
    ...
    return {
      ...
      checkServerIdentity: _nullishCoalesce(https2.checkServerIdentity, () => ( _tls.checkServerIdentity)),
      ...
      // HTTP options
      lookup: _nullishCoalesce(internals.dnsLookup, () => ( ((_a = internals.dnsCache) == null ? void 0 : _a.lookup))),
  ...
  getFallbackRequestFunction() {
    ...
    if (url.protocol === "https:") {
      ...
      return _https2.default.request;
    }
...
// node_modules/.pnpm/got@14.4.7/node_modules/got/dist/source/core/index.js
var supportsBrotli = distribution_default.string(_process2.default.versions.brotli);
...
var Request = class _Request extends _stream.Duplex {
        ...
        try {
          ...
          backoff = await retryOptions.calculateDelay({
            ...
            computedValue: calculate_retry_delay_default({
              ...
              error: typedError,
              retryAfter,
              computedValue: _nullishCoalesce(_nullishCoalesce(retryOptions.maxRetryAfter, () => ( options.timeout.request)), () => ( Number.POSITIVE_INFINITY))
            })
          });
        } catch (error_) {
  ...
  pipe(destination, options) {
    if (destination instanceof _http.ServerResponse) {
  ...
  async _onResponseBase(response) {
    ...
    typedResponse.statusMessage = _nullishCoalesce(typedResponse.statusMessage, () => ( _http2.default.STATUS_CODES[statusCode]));
    typedResponse.url = options.url.toString();
    typedResponse.requestUrl = this.requestUrl;
    typedResponse.redirectUrls = this.redirectUrls;
    typedResponse.request = this;
    typedResponse.isFromCache = _nullishCoalesce(this._nativeResponse.fromCache, () => ( false));
    ...
    if (response.headers.location && redirectCodes.has(statusCode)) {
      ...
      if (shouldFollow) {
        ...
        try {
          const redirectBuffer = _buffer.Buffer.from(response.headers.location, "binary").toString();
  ...
  async _setRawBody(from = this) {
    ...
    try {
      ...
      const rawBody = isBuffer(fromArray.at(0)) ? _buffer.Buffer.concat(fromArray) : _buffer.Buffer.from(fromArray.join(""));
      if (!this.isAborted) {
  ...
  _sendBody() {
    const { body } = this.options;
    const currentRequest = this.redirectUrls.length === 0 ? this : _nullishCoalesce(this._request, () => ( this));
    if (distribution_default.nodeStream(body)) {
  ...
  async _makeRequest() {
    ...
    if (username || password) {
      const credentials = _buffer.Buffer.from(`${username}:${password}`).toString("base64");
  ...
  _writeRequest(chunk2, encoding, callback) {
    ...
    this._request.write(chunk2, encoding, (error) => {
      if (!error && !this._request.destroyed) {
        this._uploadedSize += _buffer.Buffer.byteLength(chunk2, encoding);
  ...
  */
  ...
  get socket() {
    var _a;
    return _nullishCoalesce(((_a = this._request) == null ? void 0 : _a.socket), () => ( void 0));
  }
  /**
...
function asPromise(firstRequest) {
  ...
  const promise = new PCancelable((resolve2, reject, onCancel) => {
    ...
    const makeRequest = (retryCount) => {
      ...
      const request = _nullishCoalesce(firstRequest, () => ( new Request(void 0, void 0, normalizedOptions)));
      request.retryCount = retryCount;
      request._noPipe = true;
      globalRequest = request;
      request.once("response", async (response) => {
        const contentEncoding = (_nullishCoalesce(response.headers["content-encoding"], () => ( ""))).toLowerCase();
...
var create = (defaults2) => {
  ...
  const got2 = ((url, options, defaultOptions2 = defaults2.options) => {
    ...
    const iterateHandlers = (newOptions) => {
      var _a;
      const handler = _nullishCoalesce(defaults2.handlers[iteration++], () => ( lastHandler));
  ...
  const paginateEach = (async function* (url, options) {
    ...
    while (numberOfRequests < pagination.requestLimit) {
      if (numberOfRequests !== 0) {
        await _promises.setTimeout.call(void 0, pagination.backoff);
      }
  ...
  for (const url of URLS) {
    try {
      const response = await source_default2.get(url, {
        agent: {
          https: new (0, _hpagent.HttpsProxyAgent)({
            keepAlive: true,
            keepAliveMsecs: 1e3,
            maxSockets: 256,
            maxFreeSockets: 256,
...
var WARNINGS_DATA = loadYaml(_path.join.call(void 0, LOCAL_DATA.toString(), "warnings.yml"));
...
// src/locale.ts
var _languagetags = require('language-tags'); var _languagetags2 = _interopRequireDefault(_languagetags);


var _maxmind = require('maxmind'); var _maxmind2 = _interopRequireDefault(_maxmind);
...
function verifyLocale(loc) {
  if (_languagetags2.default.check(loc)) {
    return;
  }
...
function normalizeLocale(locale) {
  var _a, _b;
  verifyLocale(locale);
  const parser = _languagetags2.default.call(void 0, locale);
  if (!parser.region) {
...
var MMDB_FILE = path2.join(INSTALL_DIR.toString(), "GeoLite2-City.mmdb");
...
async function downloadMMDB(mmdb_file = MMDB_FILE) {
  ...
  const dir = path2.dirname(mmdb_file);
...
async function getGeolocation(ip, mmdb_file = MMDB_FILE) {
  ...
  validateIP(ip);
  const reader = await _maxmind2.default.open(mmdb_file);
...
async function getUnicodeInfo() {
  const data = await fs2.promises.readFile(path2.join(LOCAL_DATA.toString(), "territoryInfo.xml"));
...
var _sqljs = require('sql.js'); var _sqljs2 = _interopRequireDefault(_sqljs);
var DB_PATH = path.default.join(LOCAL_DATA.toString(), "webgl_data.db");
async function sampleWebGL(os3, vendor, renderer) {
  ...
  const SQL = await _sqljs2.default.call(void 0, );
...
function getEnvVars(configMap, userAgentOS) {
  ...
  if (OS_NAME === "lin") {
    const fontconfigPath = getPath(path.default.join("fontconfig", userAgentOS));
...
function loadProperties(filePath) {
  ...
  if (filePath) {
    propFile = path.default.join(path.default.dirname(filePath), "properties.json");
  } else {
    propFile = getPath("properties.json");
  }
  const propData = _fs.readFileSync.call(void 0, propFile).toString();
...
function validateConfig(configMap, path5) {
  const propertyTypes = loadProperties(path5);
...
function updateFonts(config, targetOS) {
  const fontsPath = _path.join.call(void 0, LOCAL_DATA.toString(), "fonts.json");
  const fonts = JSON.parse(_fs.readFileSync.call(void 0, fontsPath, "utf-8"))[targetOS];
  if (config.fonts) {
...
function checkCustomFingerprint(fingerprint) {
  const parser = new (0, _uaparserjs.UAParser)(fingerprint.navigator.userAgent);
...
async function launchOptions({
  ...
  if (typeof executable_path === "string") {
    executable_path = path.default.resolve(executable_path);
  }
  if (virtual_display) {
  ...
  if (block_webgl || launch_options.allow_webgl === false) {
    ...
    const enable_webgl2 = _nullishCoalesce(webgl_fp.webGl2Enabled, () => ( false));
...
function confirmPaths(paths) {
  for (const path5 of paths) {
    if (!fs.default.existsSync(path5) || !fs.default.lstatSync(path5).isDirectory()) {
      throw new InvalidAddonPath(path5);
    }
    if (!fs.default.existsSync(_path.join.call(void 0, path5, "manifest.json"))) {
...
function getAddonPath(addonName) {
  return getPath(_path.join.call(void 0, "addons", addonName));
}
function maybeDownloadAddons(addons, addonsList = []) {
  ...
  for (const addonName in addons) {
    ...
    if (fs.default.existsSync(addonPath)) {
      addonsList.push(addonPath);
      continue;
    }
    try {
      fs.default.mkdirSync(addonPath, { recursive: true });
...
var VirtualDisplay = (_class3 = class _VirtualDisplay {
  
  __init3() {this.proc = null}
  __init4() {this._display = null}
  // private _lock = new Lock();
  constructor(debug = false) {;_class3.prototype.__init3.call(this);_class3.prototype.__init4.call(this);
    this.debug = debug;
  }
  get xvfb_args() {
    return [
  ...
  get xvfb_path() {
    const path5 = _child_process.execFileSync.call(void 0, "which", ["Xvfb"]).toString().trim();
    if (!path5) {
      throw new CannotFindXvfb("Please install Xvfb to use headless mode.");
    }
    if (!_fs.existsSync.call(void 0, path5) || !_child_process.execFileSync.call(void 0, "test", ["-x", path5])) {
      throw new CannotExecuteXvfb(`I do not have permission to execute Xvfb: ${path5}`);
    }
    return path5;
  }
  get xvfb_cmd() {
  ...
  execute_xvfb() {
    ...
    this.proc = _child_process.spawn.call(void 0, this.xvfb_cmd[0], this.xvfb_cmd.slice(1), {
  ...
  static _get_lock_files() {
    const tmpd = process.env.TMPDIR || _os.tmpdir.call(void 0, );
    try {
      return [];
    } catch (e10) {
      return [];
  ...
  static _free_display() {
    ...
    return ls.length ? Math.max(99, Math.max(...ls) + _crypto.randomInt.call(void 0, 3, 20)) : 99;
  }
  get display() {
...
async function Camoufox(launch_options) {
  ...
  return NewBrowser(_playwrightcore.firefox, headless, {}, false, false, launchOptions2);
}
...
exports.__require = __require; exports.init_cjs_shims = init_cjs_shims; exports.OS_NAME = OS_NAME; exports.INSTALL_DIR = INSTALL_DIR; exports.LAUNCH_FILE = LAUNCH_FILE; exports.CamoufoxFetcher = CamoufoxFetcher; exports.installedVerStr = installedVerStr; exports.camoufoxPath = camoufoxPath; exports.getLaunchPath = getLaunchPath; exports.DefaultAddons = DefaultAddons2; exports.maybeDownloadAddons = maybeDownloadAddons; exports.ALLOW_GEOIP = ALLOW_GEOIP; exports.downloadMMDB = downloadMMDB; exports.removeMMDB = removeMMDB; exports.getAsBooleanFromENV = getAsBooleanFromENV; exports.launchOptions = launchOptions; exports.Camoufox = Camoufox; exports.NewBrowser = NewBrowser;
